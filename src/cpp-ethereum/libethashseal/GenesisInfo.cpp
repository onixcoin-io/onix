...
#include "genesis/onixMainNetwork.cpp"
...
#include "genesis/test/onixTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
    ...
    {
    //Client genesis
    case Network::onixMainNetwork: return c_genesisInfoOnixMainNetwork;
    case Network::MainNetwork: return c_genesisInfoMainNetwork;
    case Network::Ropsten: return c_genesisInfoRopsten;

    //Test genesis
    case Network::onixTestNetwork: return c_genesisInfoOnixTestNetwork;
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
    switch (_n)
    {
    case Network::onixMainNetwork: return c_genesisStateRootOnixMainNetwork;
    case Network::onixTestNetwork: return c_genesisStateRootOnixTestNetwork;
