...
////////////////////////////////////////////////////////////// // onix
    void setOnixSchedule(EVMSchedule _onixSchedule) const { onixSchedule = _onixSchedule; }

    EVMSchedule& getOnixSchedule() const { return onixSchedule; }
...
private:
    ...
    mutable EVMSchedule onixSchedule; // onix
