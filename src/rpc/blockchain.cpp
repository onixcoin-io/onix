...
double GetEstimatedAnnualROI()
{
    ...
    if(networkWeight > 0)
    {
        // Formula: 100 * 1440 blocks/day * 365 days * subsidy) / Network Weight
        result =  52560000 * subsidy / networkWeight;
    }
...
UniValue blockheaderToJSON(const CBlockIndex* tip, const CBlockIndex* blockindex)
{
    ...
    result.pushKV("hashStateRoot", blockindex->hashStateRoot.GetHex()); // onix
    result.pushKV("hashUTXORoot", blockindex->hashUTXORoot.GetHex()); // onix

    if(blockindex->IsProofOfStake()){
        result.pushKV("prevoutStakeHash", blockindex->prevoutStake.hash.GetHex()); // onix
        result.pushKV("prevoutStakeVoutN", (int64_t)blockindex->prevoutStake.n); // onix
    }
...
UniValue blockToJSON(const CBlock& block, const CBlockIndex* tip, const CBlockIndex* blockindex, bool txDetails)
{
    ...
    result.pushKV("hashStateRoot", block.hashStateRoot.GetHex()); // onix
    result.pushKV("hashUTXORoot", block.hashUTXORoot.GetHex()); // onix
...
static std::vector<RPCResult> MempoolEntryDescription() { return {
    ...
    RPCResult{RPCResult::Type::NUM, "size", "(DEPRECATED) same as vsize. Only returned if onixd is started with -deprecatedrpc=size\n"
...
UniValue getdelegationinfoforaddress(const JSONRPCRequest& request)
{
            RPCHelpMan{"getdelegationinfoforaddress",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The onix address string"},
                },
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
                ...
                RPCExamples{
                    HelpExampleCli("getdelegationinfoforaddress", "XJw9YGqx6K8DhDZAdgJkkf7w2yej6hXoQw")
            + HelpExampleRpc("getdelegationinfoforaddress", "XJw9YGqx6K8DhDZAdgJkkf7w2yej6hXoQw")
                },
            }.Check(request);
    ...
    OnixDelegation onixDelegation;
    Delegation delegation;
    uint160 address = uint160(*pkhash);
    if(!onixDelegation.GetDelegation(address, delegation)) {
        throw JSONRPCError(RPC_INTERNAL_ERROR, "Failed to get delegation");
    }
    bool verified = onixDelegation.VerifyDelegation(address, delegation);
...
UniValue getdelegationsforstaker(const JSONRPCRequest& request)
{
            RPCHelpMan{"getdelegationsforstaker",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The onix address string for staker"},
                },
               RPCResult{
            RPCResult::Type::ARR, "", "",
                {
                ...
                RPCExamples{
                    HelpExampleCli("getdelegationsforstaker", "XJw9YGqx6K8DhDZAdgJkkf7w2yej6hXoQw")
            + HelpExampleRpc("getdelegationsforstaker", "XJw9YGqx6K8DhDZAdgJkkf7w2yej6hXoQw")
                },
            }.Check(request);
    ...
    if(!onixDelegation.FilterDelegationEvents(events, filter)) {
        throw JSONRPCError(RPC_INTERNAL_ERROR, "Failed to get delegations for staker");
    }
    std::map<uint160, Delegation> delegations = onixDelegation.DelegationsFromEvents(events);
                        ...
                        {RPCResult::Type::OBJ, "scriptPubKey", "",
                            {
                                ...
                                {RPCResult::Type::ARR, "addresses", "array of onix addresses",
                                    {{RPCResult::Type::STR, "address", "onix address"}}},
                            }},
...
static UniValue qrc20balanceof(const JSONRPCRequest& request)
{
            RPCHelpMan{"qrc20balanceof",
                ...
                {
                    {"contractaddress", RPCArg::Type::STR_HEX, RPCArg::Optional::NO, "The contract address"},
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO,  "The onix address to check token balance"},
                },
                RPCResult{
                    RPCResult::Type::STR, "balance", "The token balance of the chosen address"},
                RPCExamples{
                    HelpExampleCli("qrc20balanceof", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"XFAgjbxFx1gZ3Dy7zXzVJKbdF4PkQDfKVp\"")
            + HelpExampleRpc("qrc20balanceof", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"XFAgjbxFx1gZ3Dy7zXzVJKbdF4PkQDfKVp\"")
                },
            }.Check(request);
...
static UniValue qrc20allowance(const JSONRPCRequest& request)
{
            RPCHelpMan{"qrc20allowance",
                ...
                {
                    {"contractaddress", RPCArg::Type::STR_HEX, RPCArg::Optional::NO, "The contract address"},
                    {"addressFrom", RPCArg::Type::STR, RPCArg::Optional::NO,  "The onix address of the account owning tokens"},
                    {"addressTo", RPCArg::Type::STR, RPCArg::Optional::NO,  "The onix address of the account able to transfer the tokens"},
                },
                RPCResult{
                    RPCResult::Type::STR, "allowance", "Amount of remaining tokens allowed to spent"},
                RPCExamples{
                    HelpExampleCli("qrc20allowance", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"XFAgjbxFx1gZ3Dy7zXzVJKbdF4PkQDfKVp\" \"XJw9YGqx6K8DhDZAdgJkkf7w2yej6hXoQw\"")
            + HelpExampleRpc("qrc20allowance", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"XFAgjbxFx1gZ3Dy7zXzVJKbdF4PkQDfKVp\" \"XJw9YGqx6K8DhDZAdgJkkf7w2yej6hXoQw\"")
                },
            }.Check(request);
...
static UniValue qrc20listtransactions(const JSONRPCRequest& request)
{
            RPCHelpMan{"qrc20listtransactions",
                ...
                {
                    {"contractaddress", RPCArg::Type::STR_HEX, RPCArg::Optional::NO, "The contract address."},
                    {"addresss", RPCArg::Type::STR, RPCArg::Optional::NO,  "The onix address to get history for."},
            ...
            RPCResult::Type::ARR, "", "",
                {
                    {RPCResult::Type::OBJ, "", "",
                        {
                            {RPCResult::Type::STR, "receiver", "The receiver onix address"},
                            {RPCResult::Type::STR, "sender", "The sender onix address"},
                ...
                RPCExamples{
                    HelpExampleCli("qrc20listtransactions", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"XFAgjbxFx1gZ3Dy7zXzVJKbdF4PkQDfKVp\"")
            + HelpExampleCli("qrc20listtransactions", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"XFAgjbxFx1gZ3Dy7zXzVJKbdF4PkQDfKVp\" 0 6")
            + HelpExampleRpc("qrc20listtransactions", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"XFAgjbxFx1gZ3Dy7zXzVJKbdF4PkQDfKVp\"")
            + HelpExampleRpc("qrc20listtransactions", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"XFAgjbxFx1gZ3Dy7zXzVJKbdF4PkQDfKVp\" 0 6")
                },
            }.Check(request);
