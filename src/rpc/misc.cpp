...
static UniValue validateaddress(const JSONRPCRequest& request)
{
            RPCHelpMan{"validateaddress",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The onix address to validate"},
                },
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
...
UniValue getdgpinfo(const JSONRPCRequest& request)
{
    ...
    obj.pushKV("maxblocksize", (uint64_t)onixDGP.getBlockSize(::ChainActive().Height()));
    obj.pushKV("mingasprice", (uint64_t)onixDGP.getMinGasPrice(::ChainActive().Height()));
    obj.pushKV("blockgaslimit", (uint64_t)onixDGP.getBlockGasLimit(::ChainActive().Height()));
        ...
        RPCHelpMan{"getaddressdeltas",
            "\nReturns all changes for an address (requires addressindex to be enabled).\n",
            {
                {"Input params", RPCArg::Type::OBJ, RPCArg::Optional::NO, "Json object",
                    {
                        {"addresses", RPCArg::Type::ARR, RPCArg::Optional::NO, "The onix addresses",
                            {
                                {"address", RPCArg::Type::STR, RPCArg::Optional::OMITTED, "The onix address"},
                            }
                        },
            ...
            RPCExamples{
                HelpExampleCli("getaddressdeltas", "'{\"addresses\": [\"XNX6pAzzupMgjzBaZVhyiC4jdjkTJDsmZ5\"]}'")
        + HelpExampleRpc("getaddressdeltas", "{\"addresses\": [\"XNX6pAzzupMgjzBaZVhyiC4jdjkTJDsmZ5\"]}") +
                HelpExampleCli("getaddressdeltas", "'{\"addresses\": [\"XNX6pAzzupMgjzBaZVhyiC4jdjkTJDsmZ5\"], \"start\": 5000, \"end\": 5500, \"chainInfo\": true}'")
        + HelpExampleRpc("getaddressdeltas", "{\"addresses\": [\"XNX6pAzzupMgjzBaZVhyiC4jdjkTJDsmZ5\"], \"start\": 5000, \"end\": 5500, \"chainInfo\": true}")
            },
        }.Check(request);
...
UniValue getaddressbalance(const JSONRPCRequest& request)
{
            RPCHelpMan{"getaddressbalance",
                ...
                RPCExamples{
                    HelpExampleCli("getaddressbalance", "'{\"addresses\": [\"XNX6pAzzupMgjzBaZVhyiC4jdjkTJDsmZ5\"]}'")
            + HelpExampleRpc("getaddressbalance", "{\"addresses\": [\"XNX6pAzzupMgjzBaZVhyiC4jdjkTJDsmZ5\"]}")
                },
            }.Check(request);
...
UniValue getaddressutxos(const JSONRPCRequest& request)
{
            RPCHelpMan{"getaddressutxos",
                ...
                RPCExamples{
                    HelpExampleCli("getaddressutxos", "'{\"addresses\": [\"XNX6pAzzupMgjzBaZVhyiC4jdjkTJDsmZ5\"]}'")
            + HelpExampleRpc("getaddressutxos", "{\"addresses\": [\"XNX6pAzzupMgjzBaZVhyiC4jdjkTJDsmZ5\"]}") +
                    HelpExampleCli("getaddressutxos", "'{\"addresses\": [\"XNX6pAzzupMgjzBaZVhyiC4jdjkTJDsmZ5\"], \"chainInfo\": true}'")
            + HelpExampleRpc("getaddressutxos", "{\"addresses\": [\"XNX6pAzzupMgjzBaZVhyiC4jdjkTJDsmZ5\"], \"chainInfo\": true}")
                },
            }.Check(request);
...
UniValue getaddressmempool(const JSONRPCRequest& request)
{
            RPCHelpMan{"getaddressmempool",
                ...
                RPCExamples{
                    HelpExampleCli("getaddressmempool", "'{\"addresses\": [\"XNX6pAzzupMgjzBaZVhyiC4jdjkTJDsmZ5\"]}'")
            + HelpExampleRpc("getaddressmempool", "{\"addresses\": [\"XNX6pAzzupMgjzBaZVhyiC4jdjkTJDsmZ5\"]}")
                },
            }.Check(request);
...
UniValue getaddresstxids(const JSONRPCRequest& request)
{
            RPCHelpMan{"getaddresstxids",
                ...
                RPCExamples{
                    HelpExampleCli("getaddresstxids", "'{\"addresses\": [\"XNX6pAzzupMgjzBaZVhyiC4jdjkTJDsmZ5\"]}'")
            + HelpExampleRpc("getaddresstxids", "{\"addresses\": [\"XNX6pAzzupMgjzBaZVhyiC4jdjkTJDsmZ5\"]}") +
                    HelpExampleCli("getaddresstxids", "'{\"addresses\": [\"XNX6pAzzupMgjzBaZVhyiC4jdjkTJDsmZ5\"], \"start\": 5000, \"end\": 5500}'")
            + HelpExampleRpc("getaddresstxids", "{\"addresses\": [\"XNX6pAzzupMgjzBaZVhyiC4jdjkTJDsmZ5\"], \"start\": 5000, \"end\": 5500}")
                },
            }.Check(request);
...
{
            RPCHelpMan{"listconf",
                "\nReturns the current options that onixd was started with.\n",
                {},
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
...
static UniValue createmultisig(const JSONRPCRequest& request)
{
            RPCHelpMan{"createmultisig",
                ...
                "It returns a json object with the address and redeemScript.\n",
                {
                    ...
                    {"keys", RPCArg::Type::ARR, RPCArg::Optional::NO, "A json array of keys which are onix addresses or hex-encoded public keys.",
                        {
                            {"key", RPCArg::Type::STR_HEX, RPCArg::Optional::OMITTED, "onix address or hex-encoded public key"},
                        }},
...
static UniValue verifymessage(const JSONRPCRequest& request)
{
            RPCHelpMan{"verifymessage",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The onix address to use for the signature."},
            ...
            "\nAs a JSON-RPC call\n"
            + HelpExampleRpc("verifymessage", "\"XNX6pAzzupMgjzBaZVhyiC4jdjkTJDsmZ5\", \"signature\", \"my message\"")
                },
            }.Check(request);
    ...
    if (request.fHelp)
        throw std::runtime_error(
            RPCHelpMan{"echo|echojson ...",
                ...
                "onix-cli and the GUI. There is no server-side difference.",
                {},
