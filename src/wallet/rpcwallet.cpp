    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            RPCHelpMan{"getnewaddress",
                ...
                RPCResult{
                    RPCResult::Type::STR, "address", "The new onix address"
                },
                RPCExamples{
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            RPCHelpMan{"getrawchangeaddress",
                "\nReturns a new Onix address, for receiving change.\n"
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            RPCHelpMan{"setlabel",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The onix address to be associated with a label."},
...
static UniValue sendtoaddress(const JSONRPCRequest& request)
{
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        ...
        HELP_REQUIRING_PASSPHRASE,
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The onix address to send to."},
            ...
            "                             The recipient will receive less onixs than you enter in the amount field."},
            ...
            "                             dirty if they have previously been used in a transaction."},
                    {"senderaddress", RPCArg::Type::STR, RPCArg::Optional::OMITTED_NAMED_ARG, "The onix address that will be used to send money from."},
    ...
    senderAddress = DecodeDestination(request.params[9].get_str());
        if (!IsValidDestination(senderAddress))
            throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid Onix address to send from");
        else
            fHasSender=true;
    }
        ...
        return NullUniValue;
            ...
            RPCHelpMan{"splitutxosforaddress",
                "\nSplit an address coins into utxo between min and max value." +
                    HELP_REQUIRING_PASSPHRASE,
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The onix address to split utxos."},
                ...
                RPCExamples{
                    HelpExampleCli("splitutxosforaddress", "\"XJw9YGqx6K8DhDZAdgJkkf7w2yej6hXoQw\" 100 200")
            + HelpExampleCli("splitutxosforaddress", "\"XJw9YGqx6K8DhDZAdgJkkf7w2yej6hXoQw\" 100 200 100")
            + HelpExampleRpc("splitutxosforaddress", "\"XJw9YGqx6K8DhDZAdgJkkf7w2yej6hXoQw\" 100 200")
            + HelpExampleRpc("splitutxosforaddress", "\"XJw9YGqx6K8DhDZAdgJkkf7w2yej6hXoQw\" 100 200 100")
                },
            }.Check(request);
...
static UniValue createcontract(const JSONRPCRequest& request){
    ...
    OnixDGP onixDGP(globalState.get(), fGettingValuesDGP);
    uint64_t blockGasLimit = onixDGP.getBlockGasLimit(::ChainActive().Height());
    uint64_t minGasPrice = CAmount(onixDGP.getMinGasPrice(::ChainActive().Height()));
    CAmount nGasPrice = (minGasPrice>DEFAULT_GAS_PRICE)?minGasPrice:DEFAULT_GAS_PRICE;
                ...
                HELP_REQUIRING_PASSPHRASE,
                {
                    ...
                    {"gasPrice", RPCArg::Type::AMOUNT, RPCArg::Optional::OMITTED, "gasPrice ONIX price per gas unit, default: "+FormatMoney(nGasPrice)+", min:"+FormatMoney(minGasPrice)},
                    {"senderaddress", RPCArg::Type::STR_HEX, RPCArg::Optional::OMITTED, "The onix address that will be used to create the contract."},
    ...
    CAmount nGasPrice = (minGasPrice>DEFAULT_GAS_PRICE)?minGasPrice:DEFAULT_GAS_PRICE;
                ...
                RPCHelpMan{"sendtocontract",
                    ...
                    HELP_REQUIRING_PASSPHRASE,
                    {
                        ...
                        {"gasPrice", RPCArg::Type::AMOUNT, RPCArg::Optional::OMITTED, "gasPrice Onix price per gas unit, default: "+FormatMoney(nGasPrice)+", min:"+FormatMoney(minGasPrice)},
                        {"senderaddress", RPCArg::Type::STR_HEX, RPCArg::Optional::OMITTED, "The onix address that will be used as sender."},
                        {"broadcast", RPCArg::Type::BOOL, RPCArg::Optional::OMITTED, "Whether to broadcast the transaction or not."},
                        {"changeToSender", RPCArg::Type::BOOL, RPCArg::Optional::OMITTED, "Return the change to the sender."},
                    },
                    RPCResult{
                    ...
                    + HelpExampleCli("sendtocontract", "\"c6ca2697719d00446d4ea51f6fac8fd1e9310214\" \"54f6127f\" 12.0015 6000000 "+FormatMoney(minGasPrice)+" \"XJw9YGqx6K8DhDZAdgJkkf7w2yej6hXoQw\"")
                    },
                }.Check(request);
...
static UniValue removedelegationforaddress(const JSONRPCRequest& request){
    ...
    CAmount nGasPrice = (minGasPrice>DEFAULT_GAS_PRICE)?minGasPrice:DEFAULT_GAS_PRICE;
                ...
                RPCHelpMan{"removedelegationforaddress",
                    ...
                    HELP_REQUIRING_PASSPHRASE,
                    {
                        {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The onix address to remove delegation, the address will be used as sender too."},
                        {"gasLimit", RPCArg::Type::AMOUNT, RPCArg::Optional::OMITTED, "gasLimit, default: "+i64tostr(DEFAULT_GAS_LIMIT_OP_SEND)+", max: "+i64tostr(blockGasLimit)},
                        {"gasPrice", RPCArg::Type::AMOUNT, RPCArg::Optional::OMITTED, "gasPrice Onix price per gas unit, default: "+FormatMoney(nGasPrice)+", min:"+FormatMoney(minGasPrice)},
                    },
                    RPCResult{
                    ...
                    RPCExamples{
                    HelpExampleCli("removedelegationforaddress", " \"XJw9YGqx6K8DhDZAdgJkkf7w2yej6hXoQw\" 6000000 "+FormatMoney(minGasPrice))
                    },
                }.Check(request);
    ...
    UniValue datahex = OnixDelegation::BytecodeRemove();
    UniValue amount = 0;
...
static UniValue setdelegateforaddress(const JSONRPCRequest& request){
    ...
    CAmount nGasPrice = (minGasPrice>DEFAULT_GAS_PRICE)?minGasPrice:DEFAULT_GAS_PRICE;
                ...
                RPCHelpMan{"setdelegateforaddress",
                    ...
                    HELP_REQUIRING_PASSPHRASE,
                    {
                        {"staker", RPCArg::Type::STR, RPCArg::Optional::NO, "The onix address for the staker."},
                        {"fee", RPCArg::Type::NUM, RPCArg::Optional::NO, "Percentage of the reward that will be paid to the staker."},
                        {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The onix address that contain the coins that will be delegated to the staker, the address will be used as sender too."},
                        {"gasLimit", RPCArg::Type::AMOUNT, RPCArg::Optional::OMITTED, "gasLimit, default: "+i64tostr(DEFAULT_GAS_LIMIT_OP_CREATE)+", max: "+i64tostr(blockGasLimit)},
                        {"gasPrice", RPCArg::Type::AMOUNT, RPCArg::Optional::OMITTED, "gasPrice Onix price per gas unit, default: "+FormatMoney(nGasPrice)+", min:"+FormatMoney(minGasPrice)},
                    },
                    RPCResult{
                    ...
                    RPCExamples{
                    HelpExampleCli("setdelegateforaddress", " \"XJw9YGqx6K8DhDZAdgJkkf7w2yej6hXoQw\" 10 \"XFAgjbxFx1gZ3Dy7zXzVJKbdF4PkQDfKVp\" 6000000 "+FormatMoney(minGasPrice))
                    },
                }.Check(request);
    ...
    if(!OnixDelegation::BytecodeAdd(hexStaker, fee, PoD, datahex, errorMessage))
...
static UniValue setsuperstakervaluesforaddress(const JSONRPCRequest& request){
    ...
    LOCK(pwallet->cs_wallet);
                RPCHelpMan{"setsuperstakervaluesforaddress",
                    ...
                    RPCExamples{
                        HelpExampleCli("setsuperstakervaluesforaddress", "\"{\\\"address\\\":\\\"XJw9YGqx6K8DhDZAdgJkkf7w2yej6hXoQw\\\",\\\"stakingminutxovalue\\\": \\\"100\\\",\\\"stakingminfee\\\": 10}\"")
                        + HelpExampleCli("setsuperstakervaluesforaddress", "\"{\\\"address\\\":\\\"XJw9YGqx6K8DhDZAdgJkkf7w2yej6hXoQw\\\",\\\"stakingminutxovalue\\\": \\\"100\\\",\\\"stakingminfee\\\": 10,\\\"allow\\\":[\\\"XNX6pAzzupMgjzBaZVhyiC4jdjkTJDsmZ5\\\"]}\"")
                        + HelpExampleCli("setsuperstakervaluesforaddress", "\"{\\\"address\\\":\\\"XJw9YGqx6K8DhDZAdgJkkf7w2yej6hXoQw\\\",\\\"stakingminutxovalue\\\": \\\"100\\\",\\\"stakingminfee\\\": 10,\\\"exclude\\\":[\\\"XNX6pAzzupMgjzBaZVhyiC4jdjkTJDsmZ5\\\"]}\"")
                        + HelpExampleRpc("setsuperstakervaluesforaddress", "\"{\\\"address\\\":\\\"XJw9YGqx6K8DhDZAdgJkkf7w2yej6hXoQw\\\",\\\"stakingminutxovalue\\\": \\\"100\\\",\\\"stakingminfee\\\": 10}\"")
                        + HelpExampleRpc("setsuperstakervaluesforaddress", "\"{\\\"address\\\":\\\"XJw9YGqx6K8DhDZAdgJkkf7w2yej6hXoQw\\\",\\\"stakingminutxovalue\\\": \\\"100\\\",\\\"stakingminfee\\\": 10,\\\"allow\\\":[\\\"XNX6pAzzupMgjzBaZVhyiC4jdjkTJDsmZ5\\\"]}\"")
                        + HelpExampleRpc("setsuperstakervaluesforaddress", "\"{\\\"address\\\":\\\"XJw9YGqx6K8DhDZAdgJkkf7w2yej6hXoQw\\\",\\\"stakingminutxovalue\\\": \\\"100\\\",\\\"stakingminfee\\\": 10,\\\"exclude\\\":[\\\"XNX6pAzzupMgjzBaZVhyiC4jdjkTJDsmZ5\\\"]}\"")
                    },
                }.Check(request);
...
static UniValue listsuperstakervaluesforaddress(const JSONRPCRequest& request){
    ...
    LOCK(pwallet->cs_wallet);
                RPCHelpMan{"listsuperstakervaluesforaddress",
                    ...
                    HELP_REQUIRING_PASSPHRASE,
                    {
                        {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The super staker Onix address."},
                    },
                    RPCResult{
                    RPCResult::Type::ARR, "", "",
                    {
                    ...
                    RPCExamples{
                    HelpExampleCli("listsuperstakervaluesforaddress", "XJw9YGqx6K8DhDZAdgJkkf7w2yej6hXoQw")
                    + HelpExampleRpc("listsuperstakervaluesforaddress", "XJw9YGqx6K8DhDZAdgJkkf7w2yej6hXoQw")
                    },
                }.Check(request);
...
static UniValue removesuperstakervaluesforaddress(const JSONRPCRequest& request){
    ...
    LOCK(pwallet->cs_wallet);
                RPCHelpMan{"removesuperstakervaluesforaddress",
                    ...
                    RPCResults{},
                    RPCExamples{
                    HelpExampleCli("removesuperstakervaluesforaddress", "XJw9YGqx6K8DhDZAdgJkkf7w2yej6hXoQw")
                    + HelpExampleRpc("removesuperstakervaluesforaddress", "XJw9YGqx6K8DhDZAdgJkkf7w2yej6hXoQw")
                    },
                }.Check(request);
                ...
                RPCResult{
                    RPCResult::Type::ARR, "", "",
                    {
                        {RPCResult::Type::ARR, "", "",
                        {
                            {RPCResult::Type::ARR, "", "",
                            {
                                {RPCResult::Type::STR, "address", "The onix address"},
...
static UniValue signmessage(const JSONRPCRequest& request)
{
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        ...
        HELP_REQUIRING_PASSPHRASE,
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The onix address to use for the private key."},
            ...
            + HelpExampleCli("signmessage", "\"XNX6pAzzupMgjzBaZVhyiC4jdjkTJDsmZ5\" \"my message\"") +
            "\nVerify the signature\n"
            + HelpExampleCli("verifymessage", "\"XNX6pAzzupMgjzBaZVhyiC4jdjkTJDsmZ5\" \"signature\" \"my message\"") +
            "\nAs a JSON-RPC call\n"
            + HelpExampleRpc("signmessage", "\"XNX6pAzzupMgjzBaZVhyiC4jdjkTJDsmZ5\", \"my message\"")
                },
            }.Check(request);
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            RPCHelpMan{"getreceivedbyaddress",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The onix address for transactions."},
...
static UniValue sendmany(const JSONRPCRequest& request)
{
        ...
        HELP_REQUIRING_PASSPHRASE,
                {
                    ...
                    {"amounts", RPCArg::Type::OBJ, RPCArg::Optional::NO, "The addresses and amounts",
                        {
                            {"address", RPCArg::Type::AMOUNT, RPCArg::Optional::NO, "The onix address is the key, the numeric amount (can be string) in " + CURRENCY_UNIT + " is the value"},
                        },
                    },
            ...
            "                           Those recipients will receive less onixs than you enter in their corresponding amount field.\n"
    ...
    for (const std::string& name_ : keys) {
        ...
        if (!IsValidDestination(dest)) {
            throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, std::string("Invalid Onix address: ") + name_);
        }
...
static UniValue sendmanywithdupes(const JSONRPCRequest& request)
{
    ...
    RPCHelpMan{"sendmanywithdupes",
            ...
            "the number of addresses."
                ...
                RPCExamples{
            "\nSend two amounts to two different addresses:\n"
            + HelpExampleCli("sendmanywithdupes", "\"\" \"{\\\"XNX6pAzzupMgjzBaZVhyiC4jdjkTJDsmZ5\\\":0.01,\\\"XYzqc6ctNSsqKF1xViitBXnP2oV4GcuBy6\\\":0.02}\"") +
            "\nSend two amounts to two different addresses setting the confirmation and comment:\n"
            + HelpExampleCli("sendmanywithdupes", "\"\" \"{\\\"XNX6pAzzupMgjzBaZVhyiC4jdjkTJDsmZ5\\\":0.01,\\\"XYzqc6ctNSsqKF1xViitBXnP2oV4GcuBy6\\\":0.02}\" 6 \"testing\"") +
            "\nSend two amounts to two different addresses, subtract fee from amount:\n"
            + HelpExampleCli("sendmanywithdupes", "\"\" \"{\\\"XNX6pAzzupMgjzBaZVhyiC4jdjkTJDsmZ5\\\":0.01,\\\"XYzqc6ctNSsqKF1xViitBXnP2oV4GcuBy6\\\":0.02}\" 1 \"\" \"[\\\"XNX6pAzzupMgjzBaZVhyiC4jdjkTJDsmZ5\\\",\\\"XYzqc6ctNSsqKF1xViitBXnP2oV4GcuBy6\\\"]\"") +
            "\nAs a JSON-RPC call\n"
            + HelpExampleRpc("sendmanywithdupes", "\"\", {\"XNX6pAzzupMgjzBaZVhyiC4jdjkTJDsmZ5\":0.01,\"XYzqc6ctNSsqKF1xViitBXnP2oV4GcuBy6\":0.02}, 6, \"testing\"")
                },
    }.Check(request);
        ...
        return NullUniValue;
            ...
            RPCHelpMan{"addmultisigaddress",
                ...
                "If 'label' is specified, assign address to that label.\n",
                {
                    ...
                    {"keys", RPCArg::Type::ARR, RPCArg::Optional::NO, "A json array of onix addresses or hex-encoded public keys",
                        {
                            {"key", RPCArg::Type::STR, RPCArg::Optional::OMITTED, "onix address or hex-encoded public key"},
                        },
                        },
            ...
            "              with the specified label, or \"*\" to disable filtering and return all transactions."},
                ...
                RPCResult{
                    RPCResult::Type::ARR, "", "",
                    {
                        ...
                        {
                            {RPCResult::Type::BOOL, "involvesWatchonly", "Only returns true if imported addresses were involved in transaction."},
                            {RPCResult::Type::STR, "address", "The onix address of the transaction."},
...
static UniValue gettransaction(const JSONRPCRequest& request_)
{
                ...
                RPCResult{
                    ...
                    TransactionDescriptionString()),
                    {
                        {RPCResult::Type::ARR, "details", "",
                        {
                            ...
                            {
                                {RPCResult::Type::BOOL, "involvesWatchonly", "Only returns true if imported addresses were involved in transaction."},
                                {RPCResult::Type::STR, "address", "The onix address involved in the transaction."},
                                {RPCResult::Type::STR, "category", "The transaction category.\n"
                                    "\"send\"                  Transactions sent.\n"
                                    "\"receive\"               Non-coinbase and non-coinstake transactions received.\n"
                                    "\"generate\"              Coinbase or coinstake transactions received with more than 500 confirmations.\n"
    ...
    if (!shouldWaitConf) {
        ...
        if(!request.req)
            throw JSONRPCError(RPC_INTERNAL_ERROR, "No HTTP connection. Waitconf is available from onix-cli, not onix-qt");
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            RPCHelpMan{"walletpassphrase",
                ...
                "This is needed prior to performing transactions related to private keys such as sending ONIX and staking\n"
            "\nNote:\n"
...
static UniValue encryptwallet(const JSONRPCRequest& request)
{
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            "\nNow set the passphrase to use the wallet, such as for signing or sending onix\n"
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            RPCHelpMan{"lockunspent",
                ...
                "A locked transaction output will not be chosen by automatic coin selection, when spending onixs.\n"
...
static UniValue loadwallet(const JSONRPCRequest& request)
{
            RPCHelpMan{"loadwallet",
                ...
                "\nNote that all wallet command-line options used when starting onixd will be"
...
static UniValue listunspent(const JSONRPCRequest& request)
{
    ...
    RPCHelpMan{
                ...
                "Optionally filter to only include txouts paid to specified addresses.\n",
                {
                    ...
                    {"addresses", RPCArg::Type::ARR, /* default */ "empty array", "A json array of onix addresses to filter",
                        {
                            {"address", RPCArg::Type::STR, RPCArg::Optional::OMITTED, "onix address"},
                        },
                    },
    ...
    if (!request.params[2].isNull()) {
        ...
        for (unsigned int idx = 0; idx < inputs.size(); idx++) {
            ...
            if (!IsValidDestination(dest)) {
                throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, std::string("Invalid Onix address: ") + input.get_str());
            }
    ...
    if (!options.isNull()) {
      if (options.type() == UniValue::VBOOL) {
        ...
        if (options.exists("changeAddress")) {
            ...
            if (!IsValidDestination(dest)) {
                throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "changeAddress must be a valid onix address");
            }
    ...
    RPCHelpMan{"fundrawtransaction",
                ...
                "Only pay-to-pubkey, multisig, and P2SH versions thereof are currently supported for watch-only\n",
                {
                    ...
                    {"options", RPCArg::Type::OBJ, RPCArg::Optional::OMITTED_NAMED_ARG, "for backward compatibility: passing in a true instead of an object will result in {\"includeWatching\":true}",
                        {
                            {"changeAddress", RPCArg::Type::STR, /* default */ "pool address", "The onix address to receive the change"},
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            RPCHelpMan{"getaddressinfo",
                "\nReturn information about the given onix address.\n"
                "Some of the information will only be present if the address is in the active wallet.\n",
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The onix address for which to get information."},
                },
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
                        {RPCResult::Type::STR, "address", "The onix address validated."},
            ...
            "                                                         getaddressinfo output fields for the embedded address, excluding metadata (timestamp, hdkeypath,\n"
                            ...
                            "as an array to keep the API stable if multiple labels are enabled in the future.",
                        {
                            ...
                            {RPCResult::Type::OBJ, "", "label data, DEPRECATED, will be removed in 0.21. To re-enable, launch onixd with `-deprecatedrpc=labelspurpose`",
                            {
                ...
                "Implements the Creator and Updater roles.\n",
                {
                    ...
                    {"outputs", RPCArg::Type::ARR, RPCArg::Optional::NO, "The outputs (key-value pairs), where none of the keys are duplicated.\n"
                            ...
                            "                             accepted as second parameter.",
                        {
                            {"", RPCArg::Type::OBJ, RPCArg::Optional::OMITTED, "",
                                {
                                    {"address", RPCArg::Type::AMOUNT, RPCArg::Optional::NO, "A key-value pair. The key (string) is the onix address, the value (float or string) is the amount in " + CURRENCY_UNIT + ""},
                                },
                                },
                            {"", RPCArg::Type::OBJ, RPCArg::Optional::OMITTED, "",
                                {
                    ...
                    {"options", RPCArg::Type::OBJ, RPCArg::Optional::OMITTED_NAMED_ARG, "",
                        {
                            {"changeAddress", RPCArg::Type::STR_HEX, /* default */ "pool address", "The onix address to receive the change"},
                            {"changePosition", RPCArg::Type::NUM, /* default */ "random", "The index of the change output"},
                            {"change_type", RPCArg::Type::STR, /* default */ "set by -changetype", "The output type to use. Only valid if changeAddress is not specified. Options are \"legacy\", \"p2sh-segwit\", and \"bech32\"."},
                            {"includeWatching", RPCArg::Type::BOOL, /* default */ "true for watch-only wallets, otherwise false", "Also select inputs which are watch only"},
                            {"lockUnspents", RPCArg::Type::BOOL, /* default */ "false", "Lock selected unspent outputs"},
    ...
    bool fCheckOutputs = true;
            ...
            RPCHelpMan{"qrc20approve",
                "\nOwner approves an address to spend some amount of tokens.\n",
                {
                    ...
                    {"owneraddress", RPCArg::Type::STR, RPCArg::Optional::NO, "The token owner onix address."},
                    {"spenderaddress", RPCArg::Type::STR, RPCArg::Optional::NO,  "The token spender onix address."},
                    ...
                    {"gasPrice", RPCArg::Type::AMOUNT, RPCArg::Optional::OMITTED, "The onix price per gas unit, default: "+FormatMoney(nGasPrice)+", min:"+FormatMoney(minGasPrice)},
                ...
                RPCExamples{
                    HelpExampleCli("qrc20approve", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"XFAgjbxFx1gZ3Dy7zXzVJKbdF4PkQDfKVp\" \"XJw9YGqx6K8DhDZAdgJkkf7w2yej6hXoQw\" 0.1")
            + HelpExampleCli("qrc20approve", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"XFAgjbxFx1gZ3Dy7zXzVJKbdF4PkQDfKVp\" \"XJw9YGqx6K8DhDZAdgJkkf7w2yej6hXoQw\" 0.1 "+i64tostr(DEFAULT_GAS_LIMIT_OP_SEND)+" "+FormatMoney(minGasPrice)+" true")
            + HelpExampleRpc("qrc20approve", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"XFAgjbxFx1gZ3Dy7zXzVJKbdF4PkQDfKVp\" \"XJw9YGqx6K8DhDZAdgJkkf7w2yej6hXoQw\" 0.1")
            + HelpExampleRpc("qrc20approve", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"XFAgjbxFx1gZ3Dy7zXzVJKbdF4PkQDfKVp\" \"XJw9YGqx6K8DhDZAdgJkkf7w2yej6hXoQw\" 0.1 "+i64tostr(DEFAULT_GAS_LIMIT_OP_SEND)+" "+FormatMoney(minGasPrice)+" true")
                },
            }.Check(request);
    ...
    bool fCheckOutputs = true;
            ...
            RPCHelpMan{"qrc20transfer",
                "\nSend token amount to a given address.\n",
                {
                    {"contractaddress", RPCArg::Type::STR_HEX, RPCArg::Optional::NO, "The contract address."},
                    {"owneraddress", RPCArg::Type::STR, RPCArg::Optional::NO, "The token owner onix address."},
                    {"addressto", RPCArg::Type::STR, RPCArg::Optional::NO,  "The onix address to send funds to."},
                ...
                RPCExamples{
                    HelpExampleCli("qrc20transfer", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"XFAgjbxFx1gZ3Dy7zXzVJKbdF4PkQDfKVp\" \"XJw9YGqx6K8DhDZAdgJkkf7w2yej6hXoQw\" 0.1")
            + HelpExampleCli("qrc20transfer", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"XFAgjbxFx1gZ3Dy7zXzVJKbdF4PkQDfKVp\" \"XJw9YGqx6K8DhDZAdgJkkf7w2yej6hXoQw\" 0.1 "+i64tostr(DEFAULT_GAS_LIMIT_OP_SEND)+" "+FormatMoney(minGasPrice)+" true")
            + HelpExampleRpc("qrc20transfer", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"XFAgjbxFx1gZ3Dy7zXzVJKbdF4PkQDfKVp\" \"XJw9YGqx6K8DhDZAdgJkkf7w2yej6hXoQw\" 0.1")
            + HelpExampleRpc("qrc20transfer", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"XFAgjbxFx1gZ3Dy7zXzVJKbdF4PkQDfKVp\" \"XJw9YGqx6K8DhDZAdgJkkf7w2yej6hXoQw\" 0.1 "+i64tostr(DEFAULT_GAS_LIMIT_OP_SEND)+" "+FormatMoney(minGasPrice)+" true")
                },
            }.Check(request);
    ...
    bool fCheckOutputs = true;
            ...
            RPCHelpMan{"qrc20transferfrom",
                "\nSend token amount from selected address to a given address.\n",
                {
                    ...
                    {"owneraddress", RPCArg::Type::STR, RPCArg::Optional::NO, "The token owner onix address."},
                    {"spenderaddress", RPCArg::Type::STR, RPCArg::Optional::NO,  "The token spender onix address."},
                    {"receiveraddress", RPCArg::Type::STR, RPCArg::Optional::NO,  "The token receiver onix address."},
                ...
                RPCExamples{
                    HelpExampleCli("qrc20transferfrom", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"XJw9YGqx6K8DhDZAdgJkkf7w2yej6hXoQw\" \"XFAgjbxFx1gZ3Dy7zXzVJKbdF4PkQDfKVp\" \"XXnRxs3dpYXgEipQM6RRta96gLgq8j5bNL\" 0.1")
            + HelpExampleCli("qrc20transferfrom", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"XJw9YGqx6K8DhDZAdgJkkf7w2yej6hXoQw\" \"XFAgjbxFx1gZ3Dy7zXzVJKbdF4PkQDfKVp\" \"XXnRxs3dpYXgEipQM6RRta96gLgq8j5bNL\" 0.1 "+i64tostr(DEFAULT_GAS_LIMIT_OP_SEND)+" "+FormatMoney(minGasPrice)+" true")
            + HelpExampleRpc("qrc20transferfrom", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"XJw9YGqx6K8DhDZAdgJkkf7w2yej6hXoQw\" \"XFAgjbxFx1gZ3Dy7zXzVJKbdF4PkQDfKVp\" \"XXnRxs3dpYXgEipQM6RRta96gLgq8j5bNL\" 0.1")
            + HelpExampleRpc("qrc20transferfrom", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"XJw9YGqx6K8DhDZAdgJkkf7w2yej6hXoQw\" \"XFAgjbxFx1gZ3Dy7zXzVJKbdF4PkQDfKVp\" \"XXnRxs3dpYXgEipQM6RRta96gLgq8j5bNL\" 0.1 "+i64tostr(DEFAULT_GAS_LIMIT_OP_SEND)+" "+FormatMoney(minGasPrice)+" true")
                },
            }.Check(request);
...
static UniValue qrc20burn(const JSONRPCRequest& request)
{
    ...
    bool fCheckOutputs = true;
            ...
            RPCHelpMan{"qrc20burn",
                ...
                RPCExamples{
                    HelpExampleCli("qrc20burn", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"XJw9YGqx6K8DhDZAdgJkkf7w2yej6hXoQw\" 0.1")
            + HelpExampleCli("qrc20burn", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"XJw9YGqx6K8DhDZAdgJkkf7w2yej6hXoQw\" 0.1 "+i64tostr(DEFAULT_GAS_LIMIT_OP_SEND)+" "+FormatMoney(minGasPrice)+" true")
            + HelpExampleRpc("qrc20burn", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"XJw9YGqx6K8DhDZAdgJkkf7w2yej6hXoQw\" 0.1")
            + HelpExampleRpc("qrc20burn", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"XJw9YGqx6K8DhDZAdgJkkf7w2yej6hXoQw\" 0.1 "+i64tostr(DEFAULT_GAS_LIMIT_OP_SEND)+" "+FormatMoney(minGasPrice)+" true")
                },
            }.Check(request);
...
static UniValue qrc20burnfrom(const JSONRPCRequest& request)
{
    ...
    bool fCheckOutputs = true;
            ...
            RPCHelpMan{"qrc20burnfrom",
                ...
                RPCExamples{
                    HelpExampleCli("qrc20burnfrom", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"XFAgjbxFx1gZ3Dy7zXzVJKbdF4PkQDfKVp\" \"XJw9YGqx6K8DhDZAdgJkkf7w2yej6hXoQw\" 0.1")
            + HelpExampleCli("qrc20burnfrom", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"XFAgjbxFx1gZ3Dy7zXzVJKbdF4PkQDfKVp\" \"XJw9YGqx6K8DhDZAdgJkkf7w2yej6hXoQw\" 0.1 "+i64tostr(DEFAULT_GAS_LIMIT_OP_SEND)+" "+FormatMoney(minGasPrice)+" true")
            + HelpExampleRpc("qrc20burnfrom", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"XFAgjbxFx1gZ3Dy7zXzVJKbdF4PkQDfKVp\" \"XJw9YGqx6K8DhDZAdgJkkf7w2yej6hXoQw\" 0.1")
            + HelpExampleRpc("qrc20burnfrom", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"XFAgjbxFx1gZ3Dy7zXzVJKbdF4PkQDfKVp\" \"XJw9YGqx6K8DhDZAdgJkkf7w2yej6hXoQw\" 0.1 "+i64tostr(DEFAULT_GAS_LIMIT_OP_SEND)+" "+FormatMoney(minGasPrice)+" true")
                },
            }.Check(request);
