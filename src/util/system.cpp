...
const char * const BITCOIN_CONF_FILENAME = "onix.conf";
...
{
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Onix
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Onix
    // Mac: ~/Library/Application Support/Onix
    // Unix: ~/.onix
#ifdef WIN32
    // Windows
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Onix";
#else
    // Unix
    return pathRet / ".onix";
#endif
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    if (copyright_devs.find("Onix Core") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The Onix Core Developers";
    }
