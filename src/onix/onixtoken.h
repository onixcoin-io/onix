...
public:
    ...
    void setOnixTokenExec(OnixTokenExec* tokenExec);
    ...
    // Static functions
    static bool ToHash160(const std::string& strOnixAddress, std::string& strHash160);
    static bool ToOnixAddress(const std::string& strHash160, std::string& strOnixAddress);
...
private:
    ...
    OnixToken(OnixToken const&);
    OnixToken& operator=(OnixToken const&);
