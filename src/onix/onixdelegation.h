#ifndef ONIXDELEGATION_H
#define ONIXDELEGATION_H
#include <string>
#include <vector>
#include <map>
#include <stdint.h>
...
/**
 * @brief The IOnixStaker class Delegation filter
 */
...
/**
 * @brief The OnixDelegation class Communicate with the onix delegation contract
 */
class OnixDelegation {
    
public:
    /**
     * @brief OnixDelegation Constructor
     */
    OnixDelegation();

    /**
     * @brief ~OnixDelegation Destructor
     */
    virtual ~OnixDelegation();
...
private:
    OnixDelegation(const OnixDelegation&);
    OnixDelegation& operator=(const OnixDelegation&);
    OnixDelegationPriv* priv;
};
#endif
