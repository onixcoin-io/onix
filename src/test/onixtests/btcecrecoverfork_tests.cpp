...
//    initState();
    ...
    std::vector<OnixTransaction> txBtcEcrecover;
    txBtcEcrecover.push_back(createOnixTransaction(CODE[1], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createOnixTransaction(CODE[2], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createOnixTransaction(CODE[3], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createOnixTransaction(CODE[4], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
