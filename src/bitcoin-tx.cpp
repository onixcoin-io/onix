...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " onix-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  onix-tx [options] <hex-tx> [commands]  Update hex-encoded onix transaction\n" +
            "or:     onix-tx [options] -create [commands]   Create hex-encoded onix transaction\n" +
            "\n";
