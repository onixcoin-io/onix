#ifndef ONIXVERSIONCHECKER_H
#define ONIXVERSIONCHECKER_H
...
class OnixVersionChecker : public QObject
{
    Q_OBJECT
public:
    explicit OnixVersionChecker(QObject *parent = 0);
    ~OnixVersionChecker();
