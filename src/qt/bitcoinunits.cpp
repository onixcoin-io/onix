...
QString BitcoinUnits::longName(int unit)
{
    switch(unit)
    {
    case BTC: return QString("ONIX");
    case mBTC: return QString("mONIX");
    case uBTC: return QString::fromUtf8("μONIX (bits)");
...
QString BitcoinUnits::description(int unit)
{
    ...
    case mBTC: return QString("Milli-Onixs (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-Onixs (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
