...
"""
class OnixDGPGasPriceLingeringMempoolTxTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.stop_node(1)
        self.start_node(1)
        self.nodes[1].createcontract("00", 1000000, ONIX_MIN_GAS_PRICE_STR)
...
if __name__ == '__main__':
    OnixDGPGasPriceLingeringMempoolTxTest().main()
