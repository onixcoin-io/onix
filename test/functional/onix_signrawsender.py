...
class OnixSignRawSenderTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Now send some onix to both addresses (one contract will increase its balance and the other one will throw),
