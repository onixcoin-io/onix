...
from test_framework.onixconfig import ENABLE_REDUCED_BLOCK_TIME

import sys


RPC_INVALID_PARAMETER = -8
class OnixRPCSearchlogsTestModified(BitcoinTestFramework):
...
if __name__ == '__main__':
    OnixRPCSearchlogsTestModified().main()